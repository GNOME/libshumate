/* shumate-0.12.vapi generated by vapigen, do not modify. */
...
namespace Shumate {
	...
	public class FileCache : shumate.TileCache {
		...
		protected FileCache ();
		[CCode (has_construct_function = false)]
		public FileCache.full (uint size_limit, string? cache_dir, shumate.Renderer renderer);
	...
	[CCode (cheader_filename = "shumate/shumate.h", type_id = "shumate_file_tile_source_get_type ()")]
	public class FileTileSource : shumate.TileSource {
		[CCode (has_construct_function = false)]
		protected FileTileSource ();
		[CCode (has_construct_function = false)]
		public FileTileSource.full (string id, string name, string license, string license_uri, uint min_zoom, uint max_zoom, uint tile_size, shumate.MapProjection projection, shumate.Renderer renderer);
		public void load_map_data (string map_path);
	}
	[CCode (cheader_filename = "shumate/shumate.h", type_id = "shumate_image_renderer_get_type ()")]
	public class ImageRenderer : shumate.Renderer {
		[CCode (has_construct_function = false)]
		public ImageRenderer ();
	}
	[CCode (cheader_filename = "shumate/shumate.h", type_id = "shumate_kinetic_scroll_view_get_type ()")]
	public class KineticScrollView : Clutter.Actor, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
		...
		public KineticScrollView (bool kinetic, shumate.Viewport viewport);
		public void stop ();
		[NoAccessorMethod]
	...
	public class Label : shumate.Marker, Atk.Implementor, shumate.Location, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public Label ();
		[CCode (has_construct_function = false, type = "ClutterActor*")]
	...
	public abstract class MapSource : GLib.InitiallyUnowned {
		...
		public unowned shumate.Renderer get_renderer ();
		...
		public void set_renderer (shumate.Renderer renderer);
		public shumate.MapSource next_source { get; set; }
		public shumate.Renderer renderer { get; set; }
	}
	...
	public class Marker : Clutter.Actor, Atk.Implementor, shumate.Location, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public Marker ();
	...
	public class MarkerLayer : shumate.Layer, Atk.Implementor, shumate.Exportable, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
		[CCode (has_construct_function = false)]
		public MarkerLayer ();
	...
	public class MemoryCache : shumate.TileCache {
		...
		public void clean ();
		[CCode (has_construct_function = false)]
		public MemoryCache.full (uint size_limit, shumate.Renderer renderer);
		public uint get_size_limit ();
		public void set_size_limit (uint size_limit);
		public uint size_limit { get; set construct; }
	}
	[CCode (cheader_filename = "shumate/shumate.h", type_id = "shumate_network_bbox_tile_source_get_type ()")]
	public class NetworkBboxTileSource : shumate.TileSource {
		[CCode (has_construct_function = false)]
		protected NetworkBboxTileSource ();
		[CCode (has_construct_function = false)]
		public NetworkBboxTileSource.full (string id, string name, string license, string license_uri, uint min_zoom, uint max_zoom, uint tile_size, shumate.MapProjection projection, shumate.Renderer renderer);
		public unowned string get_api_uri ();
		public void load_map_data (shumate.BoundingBox bbox);
	...
	public class NetworkTileSource : shumate.TileSource {
		...
		[CCode (has_construct_function = false)]
		public NetworkTileSource.full (string id, string name, string license, string license_uri, uint min_zoom, uint max_zoom, uint tile_size, shumate.MapProjection projection, string uri_format, shumate.Renderer renderer);
	...
	[CCode (cheader_filename = "shumate/shumate.h", type_id = "shumate_null_tile_source_get_type ()")]
	public class NullTileSource : shumate.TileSource {
		[CCode (has_construct_function = false)]
		protected NullTileSource ();
		[CCode (has_construct_function = false)]
		public NullTileSource.full (shumate.Renderer renderer);
	}
	[CCode (cheader_filename = "shumate/shumate.h", type_id = "shumate_path_layer_get_type ()")]
	public class PathLayer : shumate.Layer, Atk.Implementor, shumate.Exportable, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
		[CCode (has_construct_function = false)]
		public PathLayer ();
	...
	public class Point : shumate.Marker, Atk.Implementor, shumate.Exportable, shumate.Location, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public Point ();
		[CCode (has_construct_function = false, type = "ClutterActor*")]
	...
	[CCode (cheader_filename = "shumate/shumate.h", type_id = "shumate_renderer_get_type ()")]
	public class Renderer : GLib.InitiallyUnowned {
		[CCode (has_construct_function = false)]
		protected Renderer ();
		public virtual void render (shumate.Tile tile);
	...
	public class Tile : Clutter.Actor, Atk.Implementor, shumate.Exportable, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
		[CCode (has_construct_function = false)]
		public Tile ();
	...
	public class View : Clutter.Actor, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
		...
		public unowned shumate.License get_license_actor ();
	...
	public class Viewport : Clutter.Actor, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public Viewport ();
		public void get_adjustments (shumate.Adjustment hadjustment, shumate.Adjustment vadjustment);
		...
		public void stop ();
		[NoAccessorMethod]
		public shumate.Adjustment hadjustment { owned get; set; }
		[NoAccessorMethod]
		public shumate.Adjustment vadjustment { owned get; set; }
		[NoAccessorMethod]
	...
	[CCode (cheader_filename = "shumate/shumate.h", type_id = "shumate_exportable_get_type ()")]
	...
	[CCode (cheader_filename = "shumate/shumate.h", type_id = "shumate_location_get_type ()")]
	...
	[CCode (cheader_filename = "shumate/shumate.h", cname = "shumate_MAP_SOURCE_MEMPHIS_LOCAL")]
	public const string MAP_SOURCE_MEMPHIS_LOCAL;
	[CCode (cheader_filename = "shumate/shumate.h", cname = "shumate_MAP_SOURCE_MEMPHIS_NETWORK")]
	...
	[CCode (cheader_filename = "shumate/shumate.h", cname = "shumate_MAP_SOURCE_OAM")]
	[Deprecated]
	public const string MAP_SOURCE_OAM;
	[CCode (cheader_filename = "shumate/shumate.h", cname = "shumate_MAP_SOURCE_OSM_AERIAL_MAP")]
	[Deprecated]
	...
	[CCode (cheader_filename = "shumate/shumate.h", cname = "shumate_MAP_SOURCE_OSM_MAPQUEST")]
	[Deprecated]
	public const string MAP_SOURCE_OSM_MAPQUEST;
	[CCode (cheader_filename = "shumate/shumate.h", cname = "shumate_MAP_SOURCE_OSM_OSMARENDER")]
	[Deprecated]
